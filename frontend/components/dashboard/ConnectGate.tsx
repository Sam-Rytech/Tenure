...
/**
 * Stands in front of every dashboard page until there is a wallet on the right network.
 *
 * Each page renders this and returns early when it produces something, rather than the layout
 * doing it once, because a page needs the pool data anyway and this keeps a page's connected and
 * disconnected states in the same file.
 */
